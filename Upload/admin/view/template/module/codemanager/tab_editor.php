        ...
        <div class="col-xs-12">    
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <ul>
                        <li><?php if($register) { echo 'register_globals: Off'; }  else { echo 'register_globals: On'; } ?></li>
                    </ul>
                    <?php if(!$workspace || !$data || !$config || $register){ ?>
...
$('#install').on('click', function(e){
	 var array = {
		 project_name : '<?php echo $this->config->get('config_name');?>',
...
$('#showUsers').live('click', function(e){
